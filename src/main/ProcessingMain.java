...
public class ProcessingMain extends PApplet {
    ...
    public void setup() {
        ...
        MapzenUrl url = new MapzenUrlBuilder().setLongitude(-122.409531f).setLatitude(37.782281f).setZoom(17).setLayer("buildings").setLayer("roads").setKey("vector-tiles-PADQnWp").buildUrl();
        //New York
...
//        size(1300,850);
        size(1200,906,"processing.opengl.PGraphics3D");
//        fullScreen(P3D,2);
    }
